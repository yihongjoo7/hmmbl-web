/** [퍼블리셔] TransferHistory 목록 레이아웃 — IA No.429-438 */
...
interface TransferHistoryListViewProps {
  items?: TransferHistoryItem[];
  isLoading?: boolean;
}

export function TransferHistoryListView({ items = [], isLoading }: TransferHistoryListViewProps) {
