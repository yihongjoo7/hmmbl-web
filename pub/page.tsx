...
const PUB_SCREENS = [
  {
    domain: '적립 (earn)',
    screens: [{ label: '쿠폰 목록', href: '/dev/pub/earn/coupon-list' }],
  },
  {
    domain: ' 혜택 (rwd)',
    screens: [
      { label: '이벤트 목록', href: '/dev/pub/rwd/evt/evt-list' },
      { label: '이벤트 상세', href: '/dev/pub/rwd/evt/evt-detail' },
      { label: '퀴즈', href: '/dev/pub/rwd/qiz' },
    ],
  },
  // 도메인 추가 예시:
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          <code className="bg-gray-100 px-1 rounded">pub/</code> 폴더의 화면을 목업 데이터로
          확인합니다.
        </p>
      </div>
